...
<div class="container main_content">
	<div class="row">
		<div class="col-md-12">
			<h1 style="text-align:center; font-size:3em">Anti-Money Laundering Policy.</h1>
		</div>
	</div>
	...
	<div style="margin-top:30px;" class="row hiw_steps_con">
	    ...
	    <div class="col-md-10 hiw_steps_content">
	    	<h1 style="text-align:left; font-size:1.4em">What is Money Laundering.</h1>
	    	<p>
				...
				The main purpose of the Policy is to establish the essential standards designed to prevent Ntradex Concepts & Solutions LTD(hereinafter called "Company") from being used for money laundering and terrorism financing.
			</p>
			<p>
				Other objectives pursued by this Policy are as follows:
				• Promote a "Know Your Customer" also known as KYC policy as a cornerstone principle for the Company business ethics and practices;
	...
	<div class="row hiw_steps_con">
		<div class="col-md-1 hidden-sm hidden-xs"></div>
	    <div class="col-md-10 hiw_steps_content">
	    	<h1 style="text-align:left; font-size:1.4em">Regulatory Requirements intended to forestall and prevent Money Laundering.</h1>
	    	<p>These include;</p>
	    	<p>
			...
			<p>
				Please note that Ntradex under aforementioned laws has the right to refuse a transaction at any time should suspicion arise that it may be connected to money laundering or any other criminal activity. In addition, ntradex will be obliged to report this suspicious activity in order to comply with said regulations, and internationally accepted laws and customs which also prohibits ntradex from disclosing this information.
				Providing ntradex with false identification or contact details will be deem as a misuse of our terms of service. Ntradex is legally bound to report such misdemeanors to the authorities, and as such you may be the subject to a criminal investigation.
				Ntradex will NOT do business with anyone suspected of, or directly involved in Money Laundering, or where funds have been sourced by any illegal activity.
			</p>
			<p>
				I have read Ntradex Privacy Policy and understand and accept all terms and conditions contained herein, specially I accept and understand that ntradex is authorized to finalize the contractual relationship with myself and/or the firm I represent, lawfully and immediately, with no responsibility whatsoever, If I violate any of the clauses of this privacy policy and/or regulations of the law or any other applicable laws and regulations.
			</p>
	    </div>
	    <div class="col-md-1 hidden-sm hidden-xs"></div>
	</div>
